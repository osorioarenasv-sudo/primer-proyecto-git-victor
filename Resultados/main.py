...
for i, df in enumerate(lista_informes):  # enumerate da la posicion (i) y el contenido (df) a la vez
...
df_consolidado['precio_unitario'] = df_consolidado['precio_unitario'].fillna(promedio_precio)
